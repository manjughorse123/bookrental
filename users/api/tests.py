...
from users.api.serializers import UserListSerializer, UserCreateSerializer

#mommy.generators.add('test.generic.fields.PhoneNumberField', 'code.path.gen_func')
...
class APITests(TestCase):
    ...
    def test_list_user(self):
        ...
        assert user.phone_number == user_serializer.data.get('phone_number')
    ...
    def test_register(self):
        ...
        user = User(name=request_data.get('name'), first_name=request_data.get('first_name'), last_name=request_data.get('last_name'), email=request_data.get('email'), password=request_data.get('password'), phone_number=request_data.get('phone_number'))

        assert request_data.get('name') == user_serializer.data.get('name') 
        ...
        assert request_data.get('phone_number') == user_serializer.data.get('phone_number')
...
#         self.URLS = {
#                     'register-api': reverse('users-api:register-api'),
#                     'login-api': reverse('users-api:login-api'),
#                     'user-api': reverse('users-api:user-api'),
#                     'project-api': reverse('userd-api:project-api'),
#                      }
